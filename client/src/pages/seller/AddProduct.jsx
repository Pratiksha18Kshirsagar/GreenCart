...
const AddProduct = () => {
    ...
    const onSubmitHandler = async (e) => {
        try {
            ...
            const productData = {
                name, description: description.split('\n'),  // turns multiline string into an array
                category,
                price, offerPrice
            }
            
            const formData = new FormData();
            //Because FormData can only hold text or File values.
            // So when you're trying to send an object like productData, you need to convert it into a string using JSON.stringify
